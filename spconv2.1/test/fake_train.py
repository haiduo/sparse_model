...
class FakeClassifier(nn.Module):
    def __init__(self):
        ...
        self.net = spconv.SparseSequential(
            spconv.SubMConv3d(3, 8, 3, indice_key="subm1", padding=1,),
            nn.BatchNorm1d(8),
            nn.ReLU(),
            spconv.SparseConv3d(8, 16, 3, stride=2, padding=1, ),
            nn.BatchNorm1d(16),
            nn.ReLU(),
            spconv.SubMConv3d(16, 16, 3, indice_key="subm2", padding=1,),
            nn.BatchNorm1d(16),
            nn.ReLU(),
            spconv.SparseConv3d(16, 32, 3, stride=2, padding=1,),
            nn.BatchNorm1d(32),
            nn.ReLU(),
            spconv.SubMConv3d(32, 32, 3, indice_key="subm3", padding=1,),
            nn.BatchNorm1d(32),
            nn.ReLU(),
            spconv.SparseConv3d(32, 64, 3, stride=2, padding=1,),
            nn.BatchNorm1d(64),
            nn.ReLU(),
            spconv.SubMConv3d(64, 64, 3, indice_key="subm4", padding=1,),
            nn.BatchNorm1d(64),
            nn.ReLU(),
