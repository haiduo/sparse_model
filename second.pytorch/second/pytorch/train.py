...
def build_network(model_cfg, measure_time=False):
    # voxel_generator = voxel_builder.build(model_cfg.voxel_generator) #spconv1.2.1
    voxel_generator = voxel_builder.build(model_cfg.voxel_generator, model_cfg.num_point_features) #spconv2.1
...
def train(config_path=None,
    ...
    model_dir = "/root/second.pytorch/second/weights/ck3"
    resume = True
    #####
