...
import numpy as np
# import spconv # spconv1.2.1
import spconv.pytorch as spconv #spconv2.1
import torch
...
class SparseMiddleExtractor(nn.Module):
    def __init__(self,
        ...
        middle_layers.append(spconv.SparseConv3d(num_filters[-1],num_filters[-1], 
                                                    (3, 1, 1), (2, 1, 1), bias=False))
...
class SpMiddleFHDPeople(nn.Module):
    def __init__(self,
        ...
        self.middle_conv = spconv.SparseSequential(
            ...
            BatchNorm1d(16),
            nn.ReLU(),
            SpConv3d(16, 32, 3, 2,padding=1),  # [1600, 1200, 21] -> [800, 600, 11]
            BatchNorm1d(32),
            nn.ReLU(),
            SubMConv3d(32, 32, 3, indice_key="subm1"),
            BatchNorm1d(32),
            ...
            BatchNorm1d(32),
            nn.ReLU(),
            SpConv3d(32, 64, 3, 2,padding=[0, 1, 1]),  # [800, 600, 11] -> [400, 300, 5]
            BatchNorm1d(64),
            nn.ReLU(),
            SubMConv3d(64, 64, 3, indice_key="subm2"),
            BatchNorm1d(64),
            ...
            BatchNorm1d(64),
            nn.ReLU(),
            SpConv3d(64, 64, (3, 1, 1),(2, 1, 1)),  # [400, 300, 5] -> [400, 300, 2]
            BatchNorm1d(64),
            nn.ReLU(),
        )
        self.max_batch_size = 6
