...
class VoxelNet(nn.Module):
    def __init__(self,
        ...
        self.voxel_feature_extractor = voxel_encoder.get_vfe_class(vfe_class_name)(
            ...
            # voxel_size=self.voxel_generator.voxel_size, #spconv1.2.1
            # pc_range=self.voxel_generator.point_cloud_range, #spconv1.2.1
            voxel_size=self.voxel_generator.vsize, #spconv2.1
            pc_range=self.voxel_generator.coors_range, #spconv2.1
